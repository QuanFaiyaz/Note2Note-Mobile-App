...
$stmt = $pdo->prepare('SELECT user_id, Email, FirstName, LastName, MiddleName, Phone, Course, Account_Type, is_Admin, is_active, created_at, Password FROM users WHERE Email = :email LIMIT 1');
...
// Update last login timestamp (remove this line since last_login column doesn't exist)
