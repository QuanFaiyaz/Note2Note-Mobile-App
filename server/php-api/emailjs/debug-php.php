...
echo "Testing EmailJS API from PHP endpoint...\n";
echo "URL: " . $url . "\n";
...
if ($httpCode === 200) {
    echo "SUCCESS: EmailJS is working from PHP!\n";
} else {
    echo "FAILED: EmailJS returned error from PHP\n";
}
?>
