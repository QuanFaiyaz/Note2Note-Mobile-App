...
$stmt = $pdo->prepare('INSERT INTO notes (user_id, subject_id, title, content, file_path, file_type, file_size, is_public) VALUES (:uid, :sid, :title, :content, :file_path, :file_type, :file_size, :is_public)');
$stmt->execute([
